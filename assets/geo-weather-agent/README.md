...
Assesses geopolitical risk (ACLED) and weather conditions (Open-Meteo) along a shipping route, and checks port disruption signals (PortWatch IMF). Returns a combined risk score and estimated delay days.
