# AIS Vessel Tracking Agent

Fetches live AIS vessel position, speed, and heading from AISStream.io and computes predicted ETA to the nomination destination port using Haversine distance calculation.
