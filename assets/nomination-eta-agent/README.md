# Nomination ETA Agent

ETA Orchestrator Agent that coordinates three specialist agents (historical, AIS vessel tracking, geopolitical/weather) to produce a weighted ETA proposal for a cargo nomination. Manages the human-in-the-loop approve/reject/reassess workflow and writes approved ETAs back to OGS/650.
